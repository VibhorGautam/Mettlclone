...
const Nav=()=>{
  ...
  />
      <div>
				...
				<h1 className="mt2 mb0 baskerville i fw1 f1 animate__animated animate__backInDown" id="typewriter">  Mettlclone </h1> 
...
function Home() {
  return (
		...
		<source src={v1} type="video/mp4"/>
					...
					Mettlclone is an AI based system to provide secure and live exam proctoring system. 
