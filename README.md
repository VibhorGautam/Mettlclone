...
## Introduction
Globally, teachers and students were compelled to switch to online instruction as a result of the COVID-19 outbreak. The lectures began to be conducted via Google Meet or a Zoom call, but neither of these programmes offered a way to proctor online tests. Human proctors were unable to thoroughly inspect each student, which resulted in widespread plagiarism and cheating during online tests.
So, with this problem in mind, I had a vision, which was to try to create an automated AI model that could take the place of the human proctors and meticulously proctor each student. Additionally, the model would be able to detect similarities in student submissions and alert the appropriate authorities.
...
## Author
Vibhor Gautam, Delhi Technological University